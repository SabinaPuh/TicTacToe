...
GameMode InputEngine::GetGameTypeFromUserInput()
{
	...
	std::cout << "нажмите 2 для выбора компьютер(X) против игрока(O)" << std::endl;
	std::cout << "нажмите 3 для выбора игрок(X) против компьютера(O)" << std::endl;
	std::cout << "нажмите 4 для выбора игрок(X) против игрока(O)" << std::endl;
